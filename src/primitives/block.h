...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // estx
        hashUTXORoot.SetNull(); // estx
        vchBlockSig.clear();
    ...
    virtual bool IsProofOfStake() const //estx
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //estx
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //estx
    {
