...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " estx-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  estx-tx [options] <hex-tx> [commands]  Update hex-encoded estx transaction\n" +
            "or:     estx-tx [options] -create [commands]   Create hex-encoded estx transaction\n" +
            "\n";
