...
#include "genesis/estxMainNetwork.cpp"
...
#include "genesis/test/estxTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
    ...
    {
    //Client genesis
    case Network::estxMainNetwork: return c_genesisInfoEstxMainNetwork;
    case Network::MainNetwork: return c_genesisInfoMainNetwork;
    case Network::Ropsten: return c_genesisInfoRopsten;

    //Test genesis
    case Network::estxTestNetwork: return c_genesisInfoEstxTestNetwork;
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
    switch (_n)
    {
    case Network::estxMainNetwork: return c_genesisStateRootEstxMainNetwork;
    case Network::estxTestNetwork: return c_genesisStateRootEstxTestNetwork;
