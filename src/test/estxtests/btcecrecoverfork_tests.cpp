...
BOOST_AUTO_TEST_CASE(checking_btcecrecover_after_fork){
    ...
    std::vector<EstxTransaction> txBtcEcrecover;
    txBtcEcrecover.push_back(createEstxTransaction(CODE[1], 0, GASLIMIT, dev::u256(1), ++HASHTX, proxy));
    txBtcEcrecover.push_back(createEstxTransaction(CODE[2], 0, GASLIMIT, dev::u256(1), ++HASHTX, proxy));
    txBtcEcrecover.push_back(createEstxTransaction(CODE[3], 0, GASLIMIT, dev::u256(1), ++HASHTX, proxy));
    txBtcEcrecover.push_back(createEstxTransaction(CODE[4], 0, GASLIMIT, dev::u256(1), ++HASHTX, proxy));
