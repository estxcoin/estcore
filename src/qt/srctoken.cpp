    ...
    m_tokenTransactionView(0)
{
    ...
    connect(ui->tokensList, &QListView::clicked, this, &SRCToken::on_currentTokenChanged);
    connect(ui->tokensList, &QListView::customContextMenuRequested, this, &SRCToken::contextualMenu);
...
void SRCToken::setModel(WalletModel *_model)
{
    ...
    if(m_model && m_model->getTokenItemModel())
    {
        ...
        connect(ui->tokensList->selectionModel(), &QItemSelectionModel::currentChanged, this, &SRCToken::on_currentChanged);

        // Set current token
        connect(m_tokenModel, &QAbstractItemModel::dataChanged, this, &SRCToken::on_dataChanged);
        connect(m_tokenModel, &QAbstractItemModel::rowsInserted, this, &SRCToken::on_rowsInserted);
