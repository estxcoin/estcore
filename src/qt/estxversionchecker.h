#ifndef ESTXVERSIONCHECKER_H
#define ESTXVERSIONCHECKER_H

#include <QObject>

#define ESTX_RELEASES "https://github.com/estxproject/estx/releases"
...
class EstxVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit EstxVersionChecker(QObject *parent = 0);
    ~EstxVersionChecker();
