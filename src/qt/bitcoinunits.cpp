...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("ESTX");
    case mBTC: return QString("mESTX");
    case uBTC: return QString::fromUtf8("μESTX (bits)");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Estxs");
    case mBTC: return QString("Milli-Estxs (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Estxs (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
