...
1. Clone the Estx Core source code:
...
2.  Build Estx Core:
    ...
    Configure and build the headless Estx Core binaries as well as the GUI (if Qt is found).
...
Estx Core is now available at `./src/estxd`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/Estx"

    touch "/Users/${USER}/Library/Application Support/Estx/estx.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/Estx/estx.conf"

The first time you run estxd, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.

You can monitor the download process by looking at the debug.log file:

    tail -f $HOME/Library/Application\ Support/Estx/debug.log

Other commands:
-------

    ./src/estxd -daemon # Starts the estx daemon.
    ./src/estx-cli --help # Outputs a list of command-line options.
    ./src/estx-cli help # Outputs a list of RPC commands when the daemon is running.
